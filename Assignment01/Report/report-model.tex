...
% \begin{figure}[H]
%   \includegraphics[width=\linewidth]{gfx/MB_costitr_mitr100000_b1000.png}
%   \caption{Custo x Iterações Para Mini Batch}
%   \label{fig:costs_mbatch}
% \end{figure}
%
% \begin{figure}[H]
%   \includegraphics[width=\linewidth]{gfx/B_costitr_mitr1000.png}
%   \caption{Custo x Iterações Para Batch}
%   \label{fig:not_normalized}
% \end{figure}
